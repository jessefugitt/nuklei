 ...
 */
public class CompositeMapType extends MapType
{

    @Override
    public CompositeMapType watch(Consumer<Flyweight> notifier)
    {
    ...
    @Override
    public CompositeMapType wrap(DirectBuffer buffer, int offset, boolean mutable)
    {
        super.wrap(buffer, offset, mutable);
        return this;
    }

    public <T extends CompositeMapType> T as(T composite)
    {
    ...
    public static class Described extends Type
    {
        ...
        private final CompositeMapType composite;
        ...
        public Described()
        {
            ...
            composite = new CompositeMapType().watch((owner) -> limit(owner.limit()));
        }
        ...
        public CompositeMapType getComposite()
        {
            return composite();
        }
        ...
        private CompositeMapType composite()
        {
